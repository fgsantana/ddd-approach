...
import com.fgsantana.dddapproach.infrastructure.order.repository.hibernate.OrderItemModel
import com.fgsantana.dddapproach.infrastructure.order.repository.hibernate.OrderModel
import com.fgsantana.dddapproach.infrastructure.order.repository.hibernate.OrderRepository
...
class OrderRepositoryTests {
    ...
    fun testIfOrderIsUpdated() {
        ...
        val orderItemsUpdated = orderItems.map { itemFromDb ->
            OrderItem(itemFromDb.id!!,itemFromDb.name,itemFromDb.price,itemFromDb.productId,itemFromDb.quantity)
        }.toMutableList()
